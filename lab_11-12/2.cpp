...
{
    // Заголовок таблицы
    cout << setw(11) << left << "Разрядность" << " | "
         << setw(25) << left << "Без переполнения" << " | "
         << setw(25) << left << "С одним переполнением" << " | "
         << setw(25) << left << "С двумя переполнениями" << " | "
         << setw(10) << left << "Итог" << endl;
    ...
    for (int d : digits)
    {
        ...
        cout << setw(11) << left << d << " | "
             << setw(25) << left << (overflowNoOverflow ? "Переполнение" : resultNoOverflow) << " | "
             << setw(25) << left << (overflowOneOverflow ? "Переполнение" : resultOneOverflow) << " | "
             << setw(25) << left << (overflowTwoOverflow ? "Переполнение" : resultTwoOverflow) << " | "
             << setw(10) << left << (overflowNoOverflow || overflowOneOverflow || overflowTwoOverflow ? "Переполнение" : "Успех")
             << endl;
    }
}
